...
export function MinimalistPreview({ portfolio }: MinimalistPreviewProps) {
  ...
  return (
    <div className="minimalist-theme bg-white text-gray-800 rounded-lg shadow-sm overflow-auto max-h-[calc(100vh-200px)]">
      {/* Hero Section */}
      <div className="relative bg-gradient-to-r from-blue-500 to-indigo-600 text-white p-8 rounded-t-lg">
        ...
        <div className="relative z-10">
          ...
          {portfolio.timeline && <p className="text-blue-100 font-medium">{portfolio.timeline}</p>}
        </div>
      </div>
      ...
      <div className="p-8 grid gap-8">
        ...
        {portfolio.tools && portfolio.tools.length > 0 && portfolio.tools[0] !== "" && (
          <div className="bg-gray-50 p-6 rounded-lg">
            <h2 className="text-xl font-semibold text-blue-600 mb-4">Tools & Technologies</h2>
        ...
        {(portfolio.outcomes?.metrics || portfolio.outcomes?.testimonials) && (
          <div className="bg-gray-50 p-6 rounded-lg">
            <h2 className="text-xl font-semibold text-blue-600 mb-4">Outcomes</h2>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              {portfolio.outcomes.testimonials && (
                <div className="bg-white p-4 rounded-lg shadow-sm">
                  ...
                  <blockquote className="pl-4 border-l-4 border-blue-200 italic text-gray-700 whitespace-pre-line">
                    {portfolio.outcomes.testimonials}
                  </blockquote>
                </div>
              )}
        ...
        {((portfolio.media?.images && portfolio.media.images.length > 0 && portfolio.media.images[0]) ||
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            <h2 className="text-xl font-semibold text-blue-600 mb-4">Media</h2>
